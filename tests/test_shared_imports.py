"""Ensure capture registry does not import root-level export scripts."""
...
IDB_REGISTRY = (
    ROOT / "wxlocal" / "pipelines" / "mp_scroll" / "capture" / "idb_registry.py"
)
...
def test_idb_registry_uses_wxlocal_shared():
    ...
    assert "wxlocal.pipelines.mp_scroll.capture" in source
